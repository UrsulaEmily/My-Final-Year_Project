				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<ul class="nav navbar-nav">
							...
							<li><a href="patientapplist.php?patientId=<?php echo $userRow['icPatient']; ?>">Treatment Checkout</a></li>
...
echo "<h1>Your Treatment Checkout. </h1>";
echo "</div>";
echo "<div class='panel panel-primary'>";
echo "<div class='panel-heading'>List of Treatment</div>";
...
echo "<form method='POST'>";
                                    ...
                                    <a href='deletepatient.php?id=$id' onClick='return confirm('Are you sure you want to Checkout Treatment')' class='btn btn-warning'>CheckOut</a>
