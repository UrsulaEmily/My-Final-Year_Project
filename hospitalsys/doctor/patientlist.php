                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Clearance" disabled></th>
                                </tr>
                            </thead>
                            ...
                            while ($patientRow=mysqli_fetch_array($result)) {
                              ...
                              $id=$patientRow['icPatient'];
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td class='text-center'><a class='btn btn-primary' href='patientlist_2.php?id=$id'>Treat</a>
                            </td>";

                            echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$patientRow['icPatient']."' class='delete btn btn-warning'><span class='glyphicon glyphicon-trash' aria-hidden='true'>CLEAR</span></a>
                                    </td>";
