    ...
    <body style="background: white;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <br />
                                        <span class="help-block">By clicking Create my account, you are admitted and ready to recieve treatment.</span>
        ...
        <section id="promo-1" class="content-block promo-1 min-height-600px bg-offwhite">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <h2>Welcome to Hospital Treatment System!</h2>
                        <p>Please <span class="label label-danger">login</span> to  recieve Treatment.</p>
                    ...
                    <div class="col-md-8 col-md-offset-1 justify-content-center">
                        <div id="page-wrapper">
                <div class="container-fluid">
